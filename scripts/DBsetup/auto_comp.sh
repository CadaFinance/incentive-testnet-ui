...
NATIVE_STAKING="${NATIVE_STAKING:-0x5c85Abf043FA4567643E5631DE5880b9d7B0757B}"
TOKEN_STAKING="${TOKEN_STAKING:-0x2b5621e9CcE4B25f15ADf73F56b13868Ca986b89}"
VZUG_TOKEN="${VZUG_TOKEN:-0xc556cA3E46d96AE2474A65b8779a2d6db7b46332}"
...
const CONFIG = {
    ...
    NATIVE_STAKING: process.env.NATIVE_STAKING || "0x5c85Abf043FA4567643E5631DE5880b9d7B0757B",
    TOKEN_STAKING: process.env.TOKEN_STAKING || "0x2b5621e9CcE4B25f15ADf73F56b13868Ca986b89",
    VZUG_TOKEN: process.env.VZUG_TOKEN || "0xc556cA3E46d96AE2474A65b8779a2d6db7b46332",
